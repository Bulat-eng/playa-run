...
There is a Print button in the footer bar, and the print stylesheet forces a
light palette so it does not print a black page.

Booking confirmation numbers and flight identifiers are deliberately kept out
of this repo.
